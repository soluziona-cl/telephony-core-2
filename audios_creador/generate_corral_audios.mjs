...
const VOICEBOT_PATH = "/var/lib/asterisk/sounds/voicebot/corral";
const VOICE_ID = "marin"; 

const MESSAGES = {
    "saludo_inicial": "Hola usted se a comunicado con el Hospital comunitario y familiar de Corral.",
    ...
    "horario_atencion":"Nuestro horario de atención es de lunes a jueves de 08:00 a 17:00 horas, y viernes de 08:00 a 16:00 horas.Por favor, contáctenos dentro de este horario",
    "ocupado":"Nuestros agentes se encuentran ocupados. Usted está en el puesto número # de la fila para ser atendido.Por favor, permanezca en línea",
