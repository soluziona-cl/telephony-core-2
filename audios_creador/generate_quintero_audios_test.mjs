...
const VOICEBOT_PATH = "/var/lib/asterisk/sounds/voicebot_test";
...
const MESSAGES = {
    "test_01_greeting": "saludo",
    "test_02_rut_valido": "once millones ciento once guión k",
    "test_03_rut_lento": "mismo RUT, pausado",
    "test_04_rut_invalido": "uno dos tres",
    "test_05_silencio": "silencio real",
    "test_06_ruido": "ruido ambiente"
};
